      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          <h1 className="text-4xl font-bold tracking-tight text-zinc-800 sm:text-5xl dark:text-zinc-100">
            Software designer, founder; data, cloud specialist; AI enthusiast. 
          </h1>
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
           I am Tino, a builder of code and seeker of data’s hidden tales,
           A wanderer in clouds both digital and dreamt.
           Cautious of the rise of minds artificial,
           Yet hopeful in the warmth of human hearts.
           Father first, with easy steps and open hands,
           Loving life’s simple gifts and people’s quiet stories.
           Here, where logic meets kindness, I find my rhythm.
          </p>
